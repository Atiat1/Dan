...
export class CustomerControllerBase {
  ...
  @common.Get("/:id/jobCards")
  @ApiNestedQuery(JobCardFindManyArgs)
  async findJobCards(
    @common.Req() request: Request,
    @common.Param() params: CustomerWhereUniqueInput
  ): Promise<JobCard[]> {
    const query = plainToClass(JobCardFindManyArgs, request.query);
    const results = await this.service.findJobCards(params.id, {
      ...query,
      select: {
        createdAt: true,
  ...
  @common.Post("/:id/jobCards")
  async connectJobCards(
    @common.Param() params: CustomerWhereUniqueInput,
    @common.Body() body: JobCardWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      jobCards: {
        connect: body,
  ...
  @common.Patch("/:id/jobCards")
  async updateJobCards(
    @common.Param() params: CustomerWhereUniqueInput,
    @common.Body() body: JobCardWhereUniqueInput[]
  ): Promise<void> {
    const data = {
  ...
  @common.Delete("/:id/jobCards")
  async disconnectJobCards(
    @common.Param() params: CustomerWhereUniqueInput,
    @common.Body() body: JobCardWhereUniqueInput[]
  ): Promise<void> {
    const data = {
