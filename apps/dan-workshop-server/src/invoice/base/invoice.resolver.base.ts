...
export class InvoiceResolverBase {
  ...
  async createInvoice(
    ...
    return await this.service.createInvoice({
      ...
      data: {
        ...
        jobCard: args.data.jobCard
          ? {
              connect: args.data.jobCard,
            }
          : undefined,
      },
    });
  ...
  @graphql.ResolveField(() => JobCard, {
    nullable: true,
    name: "jobCard",
  })
  async getJobCard(@graphql.Parent() parent: Invoice): Promise<JobCard | null> {
    const result = await this.service.getJobCard(parent.id);
